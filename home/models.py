...
class GospelRandom(models.Model):
    word = models.CharField('Câu nói',default='',blank=True,max_length=300,help_text='Dài không quá 300 ký tự')
    word_jp = models.CharField('Câu nói Japanese',default='',blank=True,max_length=300,help_text='Dài không quá 300 ký tự')
    word_en = models.CharField('Câu nói English',default='',blank=True,max_length=300,help_text='Dài không quá 300 ký tự')
    ...
    reference_link = models.CharField('Nguồn tham khảo Link',null=True, blank=True,default='',max_length=5000,help_text='Nếu có nhiều nguồn vui lòng thêm dấu ";" để phân cách các nguồn tham khảo.')
    image_vertical = models.CharField('Hình ảnh dọc',null=True, blank=True,default='',max_length=400,help_text='Link drive, hình nền cho điện thoại')
    image_horizontal = models.CharField('Hình ảnh khổ ngang',null=True, blank=True,default='',max_length=400,help_text='Link drive, hình cover facebook')
