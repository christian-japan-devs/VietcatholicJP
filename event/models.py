...
class RegistrationTemp(models.Model):
    ...
    payment_code = models.CharField('Mã thanh toán',max_length=10,default='',null=True,blank=True)
    ...
    saint_name = models.CharField('Tên thánh',max_length=30,default='')
    full_name = models.CharField('Tên',max_length=200,default='')
    gender = models.CharField('Giới tính',max_length=10,default='',null=True,blank=True)
    birth_year = models.CharField('Birth Year',max_length=5,default='',null=True,blank=True)
    group_name = models.CharField('Nhóm sinh hoạt',max_length=100,default='',null=True,blank=True)
    province = models.CharField('Tỉnh',max_length=50,default='',null=True,blank=True)
    go_together = models.CharField('Đi cùng',max_length=10,default='',null=True,blank=True)
    team_no = models.CharField('Đội',max_length=100,default='',null=True,blank=True)
    type = models.CharField('Loại vé',max_length=10,default='',null=True,blank=True)
    ticket = models.ImageField('ticket',default='images/tickets/thamduvien.png',null=True, blank = True, upload_to='images/tickets')
